...
> 状态注记(2026-07-07):本文件冻结为 2026-06 的 run/artifact 索引(远端路径查询用)。当前唯一正式实验记录为 `reports/experiment-report-wan21-t2v-dmd2-progressive.md`。注意:文中 8-step 首训 run(`..._step8`)的目录已从远端消失,相关结论(13.16s、0002500 模糊)按"本地记录、artifact 不可复核"口径引用。
